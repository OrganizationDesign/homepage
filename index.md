...
<div class="hero">
  ...
  <p>
    This prototype site hosts documentation and (optionally) public snapshots of a research database on senior management team structure. Use the downloads below or browse the navigation for the codebook, terms, and methods.
  </p>
  <p>
...
## About
We introduce a public, hand-collected organizational-structure database covering 612 S&P 500 firms (1993–2024) with 216,018 executive-firm-year observations across 15,317 firm-years. Executive lists, role labels, and reporting relationships are collected from public filings and harmonized for panel analysis.
...
> *To the fullest extent permitted by law, the maintainers and contributors disclaim all warranties, whether expressed or implied (including but not limited to accuracy, completeness, merchantability, and fitness for a particular purpose), and disclaim liability for any loss or damages resulting from use of this database.*
